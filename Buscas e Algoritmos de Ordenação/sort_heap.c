...
// gcc ./include/sorts.h ./include/geradores.h ./src/sorts.c ./src/geradores.c ./tests/testasort_heap.c -o heap
...
int main()
{
    ...
    heapSort(arr, tamDoArray); // Ordena usando Heap Sort!
