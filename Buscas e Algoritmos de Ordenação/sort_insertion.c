...
// gcc ./include/sorts.h ./include/geradores.h ./src/sorts.c ./src/geradores.c ./tests/testasort_insertion.c -o insertion
...
int main()
{
    ...
    insertionSort(arr, tamDoArray); // Ordena usando Insertion Sort!
