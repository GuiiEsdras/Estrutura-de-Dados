...
// gcc ./include/sorts.h ./include/geradores.h ./src/sorts.c ./src/geradores.c ./tests/testasort_merge.c -o merge
...
int main()
{
    ...
    mergeSort(arr, 0, tamDoArray - 1); // Ordena usando Merge Sort!
